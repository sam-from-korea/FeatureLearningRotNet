...
from dataloader import DataLoaderWrapper, GenericDataset

# 파서 설정
parser = argparse.ArgumentParser()
parser.add_argument('--exp',         type=str, required=False, default='CIFAR10_supervised_NIN',
...
# 메인 실행 블록 추가 # Windows에서 Python 멀티프로세싱이 안전하게 작동하도록 하기 위해 필요
if __name__ == '__main__':  
    ...
    dloader_train = DataLoaderWrapper(
    ...
    dloader_test = DataLoaderWrapper(
